...
plt = plot_creator.get_plot("Historgams of liner correction", new_img_linCorr, new_grayscale_img_linCorr)
print("End of Task 2")
...
# Histogram of brightness
plt = plot_creator.get_plot("Histogram of britghtness after gamma correction", new_img_gammaCorr, new_grayscale_img_gammaCorr)
...
# Histograms
plt = plot_creator.get_plot("Histograms of brightness after logarithm correction", new_img_logCorr, new_grayscale_img_logCorr)
print("End of Task 3")
plt.show()